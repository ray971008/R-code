...
write.csv(be.simu, file="ZIB_beSimu sp.csv", row.names = F)
write.csv(del.simu, file="ZIB_DelSimu sp.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_cutPSimu sp.csv", row.names = F)
write.csv(train.metric, file="ZIB_trainMetric sp.csv", row.names = F)
write.csv(test.metric, file="ZIB_testMetric sp.csv", row.names = F)
