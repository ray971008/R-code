...
write.csv(metric.ann.test, file = paste0("ann_S2_testMetric spambase",".csv"), row.names = FALSE)
write.csv(metric.ann.train, file = paste0("ann_S2_trainMetric spambase",".csv"), row.names = FALSE)
