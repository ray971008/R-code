...
write.csv(be.simu, file="ZIB_S2_beSimu sp.csv", row.names = F)
write.csv(del.simu, file="ZI_S2_DelSimu sp.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_S2_cutPSimu sp.csv", row.names = F)
write.csv(train.metric, file="ZIB_S2_trainMetric sp.csv", row.names = F)
write.csv(test.metric, file="ZIB_S2_testMetric sp.csv", row.names = F)
