...
write.csv(be.simu, file="ZIB_S2_beSimu bk.csv", row.names = F)
write.csv(del.simu, file="ZIB_S2_DelSimu bk.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_S2_cutPSimu bk.csv", row.names = F)
write.csv(train.metric, file="ZIB_S2_trainMetric bk.csv", row.names = F)
write.csv(test.metric, file="ZIB_S2_testMetric bk.csv", row.names = F)
