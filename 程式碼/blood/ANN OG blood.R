...
write.csv(metric.ann.test, file = paste0("ann_testMetric blood",".csv"), row.names = FALSE)
write.csv(metric.ann.train, file = paste0("ann_trainMetric blood",".csv"), row.names = FALSE)
