...
write.csv(metric.ann.test, file = paste0("ann_S2_testMetric blood",".csv"), row.names = FALSE)
write.csv(metric.ann.train, file = paste0("ann_S2_trainMetric blood",".csv"), row.names = FALSE)
