...
write.csv(metric.CBT.test, file = paste0("CBT_S1_testMetric blood",".csv"), row.names = FALSE)
write.csv(metric.CBT.train, file = paste0("CBT_S1_trainMetric blood",".csv"), row.names = FALSE)
