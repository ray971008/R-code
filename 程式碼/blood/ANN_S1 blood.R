...
setwd('/Users/ray/Downloads/meeting/結果/blood/ANN')
write.csv(metric.ann.test, file = paste0("ann_S1_testMetric blood",".csv"), row.names = FALSE)
write.csv(metric.ann.train, file = paste0("ann_S1_trainMetric blood",".csv"), row.names = FALSE)
