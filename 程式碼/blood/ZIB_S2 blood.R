...
write.csv(be.simu, file="ZIB_S2_beSimu blood.csv", row.names = F)
write.csv(del.simu, file="ZI_S2_DelSimu blood.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_S2_cutPSimu blood.csv", row.names = F)
write.csv(train.metric, file="ZIB_S2_trainMetric blood.csv", row.names = F)
write.csv(test.metric, file="ZIB_S2_testMetric blood.csv", row.names = F)
