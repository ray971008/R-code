...
write.csv(be.simu, file="ZIB_S1_beSimu cc.csv", row.names = F)
write.csv(del.simu, file="ZIB_S1_DelSimu cc.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_S1_cutPSimu cc.csv", row.names = F)
write.csv(train.metric, file="ZIB_S1_trainMetric cc.csv", row.names = F)
write.csv(test.metric, file="ZIB_S1_testMetric cc.csv", row.names = F)
