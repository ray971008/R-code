...
write.csv(metric.CBT.train, file = paste0("CBT_S2_trainMetric cc",".csv"), row.names = FALSE)
write.csv(metric.CBT.test, file = paste0("CBT_S2_testMetric cc",".csv"), row.names = FALSE)
