...
write.csv(be.simu, file="ZIB_beSimu BCW.csv", row.names = F)
write.csv(del.simu, file="ZIB_DelSimu BCW.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_cutPSimu BCW.csv", row.names = F)
write.csv(train.metric, file="ZIB_trainMetric BCW.csv", row.names = F)
write.csv(test.metric, file="ZIB_testMetric BCW.csv", row.names = F)
