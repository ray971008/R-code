...
write.csv(metric.CBT.test, file = paste0("CBT_testMetric BCW",".csv"), row.names = FALSE)
write.csv(metric.CBT.train, file = paste0("CBT_trainMetric BCW",".csv"), row.names = FALSE)
