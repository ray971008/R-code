...
write.csv(metric.ann.test, file = paste0("ann_testMetric BCW",".csv"), row.names = FALSE)
write.csv(metric.ann.train, file = paste0("ann_trainMetric BCW",".csv"), row.names = FALSE)
