...
write.csv(be.simu, file="ZIB_S2_beSimu BCW.csv", row.names = F)
write.csv(del.simu, file="ZI_S2_DelSimu BCW.csv", row.names = F)
write.csv(cutP.simu, file="ZIB_S2_cutPSimu BCW.csv", row.names = F)
write.csv(train.metric, file="ZIB_S2_trainMetric BCW.csv", row.names = F)
write.csv(test.metric, file="ZIB_S2_testMetric BCW.csv", row.names = F)
